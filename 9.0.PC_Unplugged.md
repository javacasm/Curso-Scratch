...
La forma de funcionar es muy sencilla: repartimos unas cartas impresas previamente. Cada carta contiene un movimiento que puede hacer el robot. Usaremos las cartas para conseguir el objetivo del juego que se haya establecido. Se aparte de unas reglas de la versión clásica de movimientos, muy simples, pero podemos definir nuestras propias reglas, incluso definir un tablero distinto. Si veis las cartas recordará a los bloques de  Code.org y veremos que el sistema de juego se parece bastante.
